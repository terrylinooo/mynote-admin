 ...
 * Mynote_Post_Type_Repository
 */
class Mynote_Post_Type_Repository {
	...
	public function register_post_type() {
		register_post_type( 'repository',
			array(
				'labels' => array(
					'name'               => __( 'Repositories', 'mynote-plugin' ),
					'singular_name'      => __( 'Repository', 'mynote-plugin' ),
					'add_new'            => __( 'Add New', 'mynote-plugin' ),
					'add_new_item'       => __( 'Add New Repository', 'mynote-plugin' ),
					'edit'               => __( 'Edit', 'mynote-plugin' ),
					'edit_item'          => __( 'Edit Repository', 'mynote-plugin' ),
					'new_item'           => __( 'New Repository', 'mynote-plugin' ),
					'view'               => __( 'View Repository', 'mynote-plugin' ),
					'view_item'          => __( 'View Repository', 'mynote-plugin' ),
					'search_items'       => __( 'Search Repository', 'mynote-plugin' ),
					'not_found'          => __( 'No Repository Posts found', 'mynote-plugin' ),
					'not_found_in_trash' => __( 'No Repository Posts found in Trash', 'mynote-plugin' ),
				),
